    ...
    with placeholder.container():
        if account and 'equity' in account:
            ...
            if orders and isinstance(orders, list):
                ...
                cols_ord = ['Asset', 'Order Type', 'Side', 'Status', 'Source', 'submitted_at']
                # Filtrage des colonnes présentes
                actual_cols = [c for c in cols_ord if c in df_ord.columns]
                st.dataframe(df_ord[actual_cols], width="stretch")
            else:
